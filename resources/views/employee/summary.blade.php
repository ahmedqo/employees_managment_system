...
@section('content')
    <div class="w-full bg-white rounded-lg -mt-12 overflow-hidden">
        <div class="p-4 flex items-center justify-between gap-4">
            ...
            <div class="w-max flex items-center gap-2">
                ...
                <a href="{{ route('views.employees.summary', $data->id) }}"
        ...
        <div class="w-full overflow-y-auto no-scrollbar">
            <div class="flex w-max flex-wrap">
                ...
                <a href="{{ route('views.employees.projects', $data->id) }}"
                ...
                <a href="{{ route('views.employees.tasks', $data->id) }}"
                ...
                <a href="{{ route('views.employees.contracts', $data->id) }}"
                ...
                <a href="{{ route('views.employees.reviews.index', $data->id) }}"
                ...
                <a href="{{ route('views.employees.complaints.index', $data->id) }}"
                ...
                <a href="{{ route('views.employees.leaves', $data->id) }}"
                ...
                <a href="{{ route('views.employees.accounts', $data->id) }}"
    ...
    <div class="w-full flex flex-col gap-4 p-4 bg-white rounded-lg">
        <div class="w-full flex flex-wrap gap-4">
            <div
                class="bg-gray-50 border border-gray-300 rounded-md w-full aspect-square lg:w-auto lg:h-[275px] flex items-center justify-center">
        ...
        <div class="w-full flex flex-col gap-4">
            ...
            <div class="grid grid-rows-1 grid-cols-1 lg:grid-cols-2 gap-4">
                <div class="w-full">
                    ...
                    <div x-ucfirst
                        class="appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-md block w-full p-2 focus:outline-1 outline-blue-400">
                        ({{ $data->insurance()->first()->company }}) {{ $data->insurance()->first()->name }}</div>
                </div>
                <div class="w-full">
...
@section('print')
    ...
    <div class="flex flex-col gap-4">
        <div class="w-full flex flex-wrap gap-4">
            <div
                class="bg-gray-50 border border-gray-300 rounded-md aspect-square h-[275px] flex items-center justify-center">
                <img class="max-w-full max-h-full block"
                    src="data:image/svg+xml;base64," />
            </div>
