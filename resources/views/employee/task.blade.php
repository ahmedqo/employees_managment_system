    ...
    <div class="w-full bg-white rounded-lg -mt-12 overflow-hidden">
        <div class="p-4 flex items-center justify-between gap-4">
            ...
            <div class="w-max flex items-center gap-2">
                ...
                <a href="{{ route('views.tasks.create', ['employee' => $employee->id]) }}"
                    class="w-[42px] h-[42px] flex items-center justify-center rounded-full text-white bg-blue-400 outline-none hover:bg-blue-300 focus:bg-blue-300">
                    <svg class="block w-5 h-5 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        <path
        ...
        <div class="w-full overflow-y-auto no-scrollbar">
            <div class="flex w-max flex-wrap">
                <a href="{{ route('views.employees.summary', $employee->id) }}"
                    class="appearance-none w-max text-md flex items-center justify-center font-semibold p-2 px-4 text-gray-900 outline-none  hover:border-blue-400 focus:border-blue-400 border-b-4 {{ Help::sub('views.employees.summary') }}">
                    <span>Summary</span>
                </a>
                <a href="{{ route('views.employees.projects', $employee->id) }}"
                    class="appearance-none w-max text-md flex items-center justify-center font-semibold p-2 px-4 text-gray-900 outline-none  hover:border-blue-400 focus:border-blue-400 border-b-4 {{ Help::sub('views.employees.projects') }}">
                    <span>Projects</span>
                </a>
                <a href="{{ route('views.employees.tasks', $employee->id) }}"
                    class="appearance-none w-max text-md flex items-center justify-center font-semibold p-2 px-4 text-gray-900 outline-none  hover:border-blue-400 focus:border-blue-400 border-b-4 {{ Help::sub('views.employees.tasks') }}">
                    <span>Tasks</span>
                </a>
                <a href="{{ route('views.employees.contracts', $employee->id) }}"
                    class="appearance-none w-max text-md flex items-center justify-center font-semibold p-2 px-4 text-gray-900 outline-none  hover:border-blue-400 focus:border-blue-400 border-b-4 {{ Help::sub('views.employees.contracts') }}">
                    <span>Contracts</span>
                </a>
                <a href="{{ route('views.employees.reviews.index', $employee->id) }}"
                    class="appearance-none w-max text-md flex items-center justify-center font-semibold p-2 px-4 text-gray-900 outline-none  hover:border-blue-400 focus:border-blue-400 border-b-4 {{ Help::sub('views.employees.reviews.index') }}">
                    <span>Reviews</span>
                </a>
                <a href="{{ route('views.employees.complaints.index', $employee->id) }}"
                    class="appearance-none w-max text-md flex items-center justify-center font-semibold p-2 px-4 text-gray-900 outline-none  hover:border-blue-400 focus:border-blue-400 border-b-4 {{ Help::sub('views.employees.complaints.index') }}">
                    <span>Complaints</span>
                </a>
                <a href="{{ route('views.employees.leaves', $employee->id) }}"
                    class="appearance-none w-max text-md flex items-center justify-center font-semibold p-2 px-4 text-gray-900 outline-none  hover:border-blue-400 focus:border-blue-400 border-b-4 {{ Help::sub('views.employees.leaves') }}">
                    <span>Leaves</span>
                </a>
                <a href="{{ route('views.employees.accounts', $employee->id) }}"
                    class="appearance-none w-max text-md flex items-center justify-center font-semibold p-2 px-4 text-gray-900 outline-none  hover:border-blue-400 focus:border-blue-400 border-b-4 {{ Help::sub('views.employees.accounts') }}">
                    <span>Accounts</span>
                </a>
                <a x-tab="#documents"
                    class="appearance-none w-max text-md flex items-center justify-center font-semibold p-2 px-4 text-gray-900 outline-none  hover:border-blue-400 focus:border-blue-400 border-b-4 {{ Help::sub('views.employees.documents') }}">
                    <span>Documents</span>
                </a>
            </div>
        </div>
                ...
                <ul x-wrap="pending" class="bg-white p-2 rounded-lg w-full min-h-[50px] flex flex-col gap-2">
                    @foreach ($pending as $row)
                        <li x-item="{{ $row->id }}" draggable="true"
                            class="w-full flex flex-col gap-1 {{ Help::color($row->priority) }} p-2 rounded-md">
                            <a href="{{ route('views.tasks.summary', $row->id) }}"
                                class="block w-max text-gray-900 font-bold text-md hover:underline">
                                #{{ $row->id }} {{ $row->name }}
                            </a>
