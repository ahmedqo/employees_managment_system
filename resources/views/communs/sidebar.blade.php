<aside id="menu"
    ...
    <nav
        class="w-9/12 lg:w-full h-full flex flex-col gap-6 bg-white absolute top-0 left-0 border-r border-gray-300 overflow-y-auto">
        <header class="w-full flex items-center justify-center p-4">
            <h1 class="text-gray-900 font-black text-2xl">HA Groupe</h1>
        </header>
        <ul class="flex flex-col">
            <li class="w-full">
                <a href="{{ route('views.dashboard') }}"
                    class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.dashboard') }} bg-yellow-500">
                ...
                <ul id="sub-6" class="w-full hidden flex-col border-y border-gray-300">
                    <li class="w-full">
                        <a href="{{ route('views.projects.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.projects.index') }}">
                    ...
                    <li class="w-full">
                        <a href="{{ route('views.tasks.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.tasks.index') }}">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                ...
                <ul id="sub-1" class="w-full hidden flex-col border-y border-gray-300">
                    <li class="w-full">
                        <a href="{{ route('views.departments.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.departments.index') }}">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                    ...
                    <li class="w-full">
                        <a href="{{ route('test') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('test') }} bg-red-500 bg-opacity-10">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
            ...
            {{-- <li class="w-full flex flex-col">
                <button x-toggle="#sub-3, #sub-show-3, #sub-hide-3" x-property="hidden, flex"
                    class="w-full flex flex-wrap gap-2 justify-between items-center px-4 py-2 cursor-pointer outline-none text-gray-900">
                    <div class="w-max flex gap-2 flex-wrap items-center">
                        <svg class="block w-5 h-5 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                            <path
                        ...
                        <span class="text-sm font-black">Workforce</span>
                    </div>
                    <svg id="sub-show-3" class="hidden w-4 h-4 text-gray-900 pointer-events-none" fill="currentcolor"
                        viewBox="0 0 48 48">
                        <path d="M24 31.8 10.9 18.7 14.2 15.45 24 25.35 33.85 15.5 37.1 18.75Z"></path>
                    </svg>
                    <svg id="sub-hide-3" class="flex w-4 h-4 pointer-events-none" fill="currentcolor"
                        viewBox="0 0 48 48">
                        <path
                            d="M17.2 35.45q-.7-.75-.7-1.675t.7-1.575l8.2-8.25-8.25-8.3q-.7-.6-.675-1.6.025-1 .725-1.65.65-.7 1.575-.675.925.025 1.575.675l9.95 9.95q.3.3.5.725t.2.875q0 .5-.2.9t-.5.7l-9.9 9.9q-.65.65-1.6.625-.95-.025-1.6-.625Z" />
                    </svg>
                </button>
                <ul id="sub-3" class="w-full hidden flex-col border-y border-gray-300">
                    <li class="w-full">
                        <a href="{{ route('views.contracts.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.contracts.index') }}">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                    ...
                    <li class="w-full">
                        <a href="{{ route('views.employees.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.employees.index') }}">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                    ...
                    <li class="w-full">
                        <a href="{{ route('views.insurances.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.insurances.index') }}">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                    ...
                    <li class="w-full">
                        <a href="{{ route('views.leaves.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.leaves.index') }}">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                    ...
                    <li class="w-full">
                        <a href="{{ route('views.policies.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.policies.index') }}">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                    ...
                    <li class="w-full">
                        <a href="{{ route('views.reviews.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.reviews.index') }}">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                ...
                <ul id="sub-2" class="w-full hidden flex-col border-y border-gray-300">
                    <li class="w-full">
                        <a href="{{ route('views.clients.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.clients.index') }}">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                    ...
                    <li class="w-full">
                        <a href="{{ route('views.contacts.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.contacts.index') }}">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                ...
                <ul id="sub-4" class="w-full hidden flex-col border-y border-gray-300">
                    <li class="w-full">
                        <a href="{{ route('views.complaints.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.complaints.index') }}">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                    ...
                    <li class="w-full">
                        <a href="{{ route('views.terminations.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.terminations.index') }}">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                ...
                <ul id="sub-5" class="w-full hidden flex-col border-y border-gray-300">
                    <li class="w-full">
                        <a href="{{ route('views.accounts.index') }}"
                            class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-blue-400 hover:bg-opacity-50 focus:bg-gray-900 focus:bg-opacity-20 {{ Help::base('views.accounts.index') }}">
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                    ...
                    <li class="w-full">
                        <a href="{{ route('test') }}"
                            ...
                            <div class="w-4 h-4 flex items-center justify-center"><span
                                    class="w-1.5 h-1.5 rounded-full bg-gray-900"></span></div>
                            <span class="text-sm font-medium">Salaries</span>
                        </a>
                    </li>
                </ul>
            </li>
