                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <select x-select id="status" placeholder="Status" name="status">
                            <option x-ucfirst value="pending" @if ($data->status == 'pending') selected @endif>Pendding
                            </option>
                            <option x-ucfirst value="approved" @if ($data->status == 'approved') selected @endif>Approved
                            </option>
                            <option x-ucfirst value="rejected" @if ($data->status == 'rejected') selected @endif>Rejected
                            </option>
                        </select>
                    </div>
                </div>
