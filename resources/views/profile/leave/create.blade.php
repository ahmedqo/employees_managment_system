                    ...
                    <div class="w-full">
                        ...
                        <div class="relative">
                            <select x-select id="type" placeholder="Type" name="type">
                                <option x-ucfirst value="compassionate">Compassionate</option>
                                <option x-ucfirst value="long service">Long service</option>
                                <option x-ucfirst value="personal">Personal</option>
                                <option x-ucfirst value="medical">Medical</option>
                                <option x-ucfirst value="annual">Annual</option>
                                <option x-ucfirst value="unpaid">Unpaid</option>
                                <option x-ucfirst value="other">Other</option>
                            </select>
                        </div>
                    </div>
                    <div class="w-full">
