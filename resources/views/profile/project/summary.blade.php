...
@section('content')
    <div class="w-full bg-white rounded-lg-mt-12">
                        ...
                        <ul id="status"
                            ...
                            <li class="w-full">
                                <a href="{{ route('actions.profile.projects.status', ['id' => $data->id, 'status' => 'pending']) }}"
                                    class="w-full flex gap-2 items-center px-4 py-2 outline-none text-gray-900 hover:bg-gray-900 hover:bg-opacity-10 focus:bg-gray-900 focus:bg-opacity-10 {{ Help::base('views.profile.summary') }}">
