    ...
    <div class="w-full bg-white rounded-lg -mt-12 overflow-hidden">
        ...
        <div class="w-full overflow-y-auto no-scrollbar">
            <div class="flex w-max flex-wrap">
                <a href="{{ route('views.profile.projects.summary', $data->id) }}"
                    class="appearance-none w-max text-md flex items-center justify-center font-semibold p-2 px-4 text-gray-900 outline-none  hover:border-blue-400 focus:border-blue-400 border-b-4 {{ Help::sub('views.profile.projects.summary') }}">
                    <span>Summary</span>
                </a>
                <a href="{{ route('views.profile.projects.tasks', $data->id) }}"
                    class="appearance-none w-max text-md flex items-center justify-center font-semibold p-2 px-4 text-gray-900 outline-none  hover:border-blue-400 focus:border-blue-400 border-b-4 {{ Help::sub('views.profile.projects.tasks') }}">
                    <span>Tasks</span>
                </a>
                <a href="{{ route('test') }}"
