    ...
    <div class="grid grid-rows-1 grid-cols-1 gap-4">
        <div class="w-full bg-white p-4 rounded-lg ">
            <form action="{{ route('actions.contracts.store') }}" method="POST" class="w-full flex flex-col gap-4">
                    ...
                    <div class="w-full">
                        ...
                        <div class="relative">
                            <select x-select id="type" placeholder="Type" name="type">
                                <option x-ucfirst value="CDD">CDD</option>
                                <option x-ucfirst value="CDI">CDI</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="w-full">
                        ...
                        <div class="relative">
                            <select x-select id="compensation" placeholder="Compensation" name="compensation">
                                @foreach (Help::compensations() as $compensation)
                ...
                <div class="w-full">
                    <button type="submit"
                        class="appearance-none lg:w-max ml-auto text-md flex items-center justify-center rounded-md font-semibold w-full p-2 px-4 text-white outline-none bg-blue-400 hover:bg-blue-300 focus:bg-blue-300 shadow-sm">
