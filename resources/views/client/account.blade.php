    ...
    <div class="w-full bg-white rounded-lg -mt-12 overflow-hidden">
        ...
        <div class="w-full overflow-y-auto">
            <div class="flex w-max flex-wrap">
                <a href="{{ route('views.clients.summary', $client->id) }}"
                ...
                <a href="{{ route('views.clients.contacts', $client->id) }}"
                ...
                <a href="{{ route('views.clients.projects', $client->id) }}"
                ...
                <a href="{{ route('views.clients.accounts', $client->id) }}"
