                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <textarea id="address" type="text" placeholder="Address" name="address"
                            class="appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-md block w-full p-2 focus:outline-1 outline-blue-400">{{ $data->address }}</textarea>
                    </div>
                </div>
                <div class="w-full">
