...
const Program = {
    ucfirst(opts = {}) {
        ...
        for (let i = 0; i < targets.length; i++) {
            ...
            current.innerText = text[0].toUpperCase() + text.slice(1);
    ...
    password(opts = {}) {
        ...
        for (let i = 0; i < targets.length; i++) {
            ...
            `
            current.className = "appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-md block w-full pr-10 p-2 focus:outline-1 outline-blue-400";
            ...
            wrapper.innerHTML = /*html*/ `
                <div class="w-full flex flex-wrap gap-4 p-2 border-b border-gray-300">
                    <div class="flex-1 flex flex-wrap gap-2">
                        <button data-command="bold" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                        ...
                        <button data-command="italic" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="underline" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="strikeThrough" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <select data-command="fontName" class="block text-gray-900 text-sm rounded-md focus:outline-1 outline-blue-400">
                        ...
                        <select data-command="fontSize" class="block text-gray-900 text-sm rounded-md focus:outline-1 outline-blue-400">
                        ...
                        <select data-command="formatBlock" class="block text-gray-900 text-sm rounded-md focus:outline-1 outline-blue-400">
                        ...
                        <label tabindex="0" for="forecolor" class="relative flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                        ...
                        <label tabindex="0" for="backColor" class="relative flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                        ...
                        <button data-command="justifyLeft" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="justifyCenter" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="justifyRight" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="insertParagraph" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="insertUnorderedList" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="insertOrderedList" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="indent" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="outdent" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="createLink" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="insertImage" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="undo" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="redo" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button data-command="removeFormat" class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                    ...
                    <div class="ml-auto" data-screen>
                        <button class="flex items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                        ...
                        <button class="hidden items-center justify-center w-6 h-6 appearance-none text-gray-900 rounded-md outline-none focus:bg-gray-200 hover:bg-gray-200">
                            <svg class="block w-5 h-5 text-gray-900 pointer-events-none" fill="currentcolor" viewBox="0 0 48 48">
                ...
                <div class="w-full h-48 rounded-md focus:outline-1 outline-blue-400 overflow-y-auto resize-y p-4 revert"
    ...
    select(opts = {}) {
        ...
        for (let i = 0; i < targets.length; i++) {
            ...
            wrapper.innerHTML = /*html*/ `
                <div tabindex="0" class="w-full bg-gray-50 border border-gray-300 appearance-none text-gray-900 text-md rounded-md pr-10 p-2 focus:outline-1 outline-blue-400 cursor-pointer">
        ...
        for (let i = 0; i < targets.length; i++) {
            ...
            wrapper.innerHTML = /*html*/ `
                <div class="flex gap-4 justify-between">
                    <input type="search" placeholder="Search..." class="flex-1 lg:w-56 lg:flex-none appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-md block p-2 focus:outline-1 outline-blue-400" />
                    <div class="w-max flex flex-wrap gap-4 items-stretch">
                        <div class="w-24 relative">
                            <select class="w-full appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-md block p-2 focus:outline-1 outline-blue-400">
    ...
    date(opts = {}) {
        ...
        for (let i = 0; i < targets.length; i++) {
            ...
            classes.add(wrapper, "relative");
            wrapper.innerHTML = /*html*/ `
                <input readonly type="text" placeholder="${current.getAttribute("placeholder")||""}" class="appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-md block w-full pr-10 p-2 focus:outline-1 outline-blue-400 cursor-pointer"
                />
    ...
    for (const file of e.files) {
        ...
        e.parentElement.nextElementSibling.insertAdjacentHTML('afterbegin', `
            <div class="flex flex-wrap gap-2 items-center justify-between p-2 border-t border-gray-300">
                <input data-file type="checkbox" onchange="remove(event)" class="w-5 h-5 accent-blue-400 cursor-pointer peer" />
